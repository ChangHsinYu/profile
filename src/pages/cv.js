    ...
    return(
      <div>
        ...
        <div className="cv_content">
          ...
          <br/>
          Born in Hsinchu(Taiwan) in 1999, He is currently studying in the Department of New Media Art of Taipei University of Arts. He likes to experiment sound. For him, sound is an exploration of the world and an abstract but direct energy. His installation works discuss the spatiality, mechanism and translation of sound, and focus on the method of sound generation. In his view, the randomness generated by the mechanism is more exciting and vitality than the complete planning and control of the final result. His works also through the generative mechanism of sound to response various experiences and issues. His AudioVisual performances are usually created through programming and extend possibilities of the purest elements. He generally create and destroy structures in performances, and seem noise as a liberating energy.<br/>
          <br/><br/>
          ...
          <br/>
          1999年生於新竹，現就讀北藝大新媒體藝術學系。喜歡實驗聲響，對他來說聲響是對世界的探索也是種抽象卻直接的能量。他的裝置作品經常探討聲音的空間性、發聲機制及訊號的轉譯，注重聲音生成的方法，對他來說比起完整規劃並控制最後的結果，在他創造的機制下產生的隨機性是更令人期待且有生命力的，同時也透過創造的規則呼應生活中的經驗感受及議題。音像表演習慣透過編寫程式創作，常用最單純的元素延展出豐富的可能性，喜歡在表演中創造結構並破壞結構，以噪音作為某種解放的能量。<br/>
          <br/>
          <br/>
