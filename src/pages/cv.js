    ...
    return(
      <div>
        ...
        <div className="cv_content">
          ...
          <br/>
          Chang Hsin Yu is an interactive / sound / installation artist based in Taiwan, currently studying in the Department of New Media Art of Taipei University of Arts.
...
His audio/visual performances are usually created through programming, focused on the relationship between sound and image and extend possibilities of the purest elements. He generally create and destroy structures in performances, and seem noise as a liberating energy.<br/>
          ...
          <br/>
          1999年生於新竹，現就讀北藝大新媒體藝術學系。喜歡實驗聲響，對我來說聲響是對世界的探索、抽象卻直接的能量和無形的精神力量。我的裝置作品經常探討聲音的空間性、發聲機制及訊號的轉譯，注重聲音生成的方法，同時透過運作的規則呼應生活中的經驗感受及議題。對我來說比起完整規劃並控制最後的結果，在我創造的機制下產生的聲音的隨機性是更令人期待且有生命力的。音像表演習慣透過編寫程式創作，關注聲音與影像之間相互觸發的關係，常用最單純的元素延展出豐富的可能性，喜歡在表演中創造結構並破壞結構，以噪音作為某種解放的能量。<br/>
          <br/>
          <br/>
